...
export const Toast = ({ message, type, toastOnClose }) => {
    useEffect(() => {
        const timer = setTimeout(toastOnClose, 360000);
        return () => clearTimeout(timer);
      }, [toastOnClose]);
  return (
    <div className={type == "success" ? "toast-container" : "toast-container toast-danger"}>
      <p>{message}</p>
      <div className="toast-btn-container">
        <button className="toast-btn" onClick={toastOnClose}>
